  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100 flex flex-col items-center justify-center p-8">
      ...
      <div className="mb-8 flex items-center gap-6">
        ...
        <motion.div
          animate={{ opacity: gameEnded ? 1 : 0, scale: gameEnded ? 1 : 0.8 }}
          transition={{ duration: 0.4 }}
          className={`text-2xl font-bold uppercase tracking-widest min-w-[100px] ${
            score > 0 ? 'text-green-600' : score === 0 ? 'text-amber-600' : 'text-red-600'
          }`}
        >
